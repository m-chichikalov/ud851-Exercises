...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mLoadingProgressProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingProgressProgressBar = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    }
    ...
    private void showErrorMessage() {
        ...
        mLoadingProgressProgressBar.setVisibility(View.INVISIBLE);
    }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            mLoadingProgressProgressBar.setVisibility(View.VISIBLE);
        }
